...
$value = Yaml::parse(file_get_contents(\'/path/to/file.yml\'));</code></pre>',
            ...
            [
                ...
                'answers' => [
                    ['text' => '<code>public function load($resource, $locale, $domain);</code>', 'correct' => true],
                    ...
                    ['text' => '<code>public function load($resource, $locale, $domain = \'messages\');</code>', 'correct' => false],
