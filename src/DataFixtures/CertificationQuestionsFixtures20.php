    ...
    private function getSubcategories(ObjectManager $manager, Category $symfony, Category $php): array
    {
        ...
        $additional = [
            'Symfony' => [
                ...
                'Mime' => 'Mime component for MIME types handling',
                'BrowserKit' => 'BrowserKit component for simulating browser behavior',
                'Config' => 'Config component for loading and validating configuration',
            ],
        ];
