 ...
 */
final class Version20251215160502 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__question AS SELECT id, text, explanation, type, difficulty, created_at, updated_at, is_certification, category_id, subcategory_id, resource_url, identifier FROM question');
        $this->addSql('DROP TABLE question');
        $this->addSql('CREATE TABLE question (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, text CLOB NOT NULL, explanation CLOB DEFAULT NULL, type VARCHAR(20) NOT NULL, difficulty INTEGER NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, is_certification BOOLEAN DEFAULT 0 NOT NULL, category_id INTEGER NOT NULL, subcategory_id INTEGER NOT NULL, resource_url CLOB DEFAULT NULL, identifier VARCHAR(64) DEFAULT NULL, CONSTRAINT FK_B6F7494E12469DE2 FOREIGN KEY (category_id) REFERENCES category (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6F7494E5DC6FE57 FOREIGN KEY (subcategory_id) REFERENCES subcategory (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO question (id, text, explanation, type, difficulty, created_at, updated_at, is_certification, category_id, subcategory_id, resource_url, identifier) SELECT id, text, explanation, type, difficulty, created_at, updated_at, is_certification, category_id, subcategory_id, resource_url, identifier FROM __temp__question');
